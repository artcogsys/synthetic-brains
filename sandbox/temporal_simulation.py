# Demonstrates recovery of model parameters for one population with an optionally delayed population response and direct
...
n_stim = 10  # number of input stimuli
n_pop = 1    # number of assumed neural populations
n_resp = 1  # number of measured responses - unused in this example
...
def create_model():
    ...
    populations = [NPGRUPopulation() for ix in range(n_pop)]
...
# Cutoff can be lowered to realize truncated backpropagation
